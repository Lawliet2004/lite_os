...
int elf_load_into_process(struct process *proc, const void *elf_data, size_t elf_size, int argc, char **argv, char **envp, const char *exec_path, uint64_t *out_entry, uint64_t *out_rsp, int at_secure);
